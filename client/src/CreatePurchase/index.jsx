...
const CreatePurchase = () => {
  ...
  //e is the event that something was entered
  ...
  const handleCreatePurchase = async (e) => {
      ...
      //logs into terminal in DOM (inspect element)
      const payload = {
          purchase: formData
      };
  ...
  return (
    <div className="create-purchase-container">
      <div className="create-purchase-form">
        ...
        <div className="create-row">
          <label>Date</label>
          <input type="date" name="date" placeholder="mm/dd/yy" onChange={(handleChange)}/>
        </div>
        <div className="create-row">
          <label>Cost</label>
